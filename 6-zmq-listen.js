...
var address= "ICTEDCLNJWGFV9RPSFTHNIYJLNXOV9DRYINDFSO9NYWG9PXBFTQU9QCQHICHYHPKAPRLZYBXOAEIKBLLA"

console.log('Watching for transactions to this address: ' + address)
  console.log(
    'Remember to send a TX to this address & be patient it can take 30seconds for the tx appear.'
  )
  // Subscribe to the address thats passed in via the CLI
